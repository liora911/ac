        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-lg">
          ...
          <form onSubmit={handleEmailSignIn} className="space-y-5" noValidate>
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="block w-full rounded-lg border border-gray-300 bg-white pr-10 pl-4 py-3 text-sm shadow-sm placeholder:text-gray-400 focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/20"
                />
              </div>
            </div>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 rounded-lg bg-emerald-600 px-4 py-3 text-sm font-medium text-white shadow-sm hover:bg-emerald-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-600 disabled:cursor-not-allowed disabled:opacity-50 transition-colors"
            >
              {isLoading ? (
                <>
