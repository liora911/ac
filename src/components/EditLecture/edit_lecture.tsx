      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          ...
          <input
            ...
            required
            className="w-full p-4 bg-white text-gray-900 border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-500 rtl"
        ...
        <div>
          ...
          <input
            ...
            onChange={handleChange}
            className="w-full p-4 bg-white text-gray-900 border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-500"
            placeholder="https://"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            value={formData.date}
            onChange={handleChange}
            className="w-full p-4 bg-white text-gray-900 border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          />
        </div>
        ...
        <div>
          ...
          <select
            ...
            className="w-full p-4 bg-white text-gray-900 border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:opacity-50 rtl"
          >
            <option value="">
          ...
          <div className="mt-4 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full p-3 bg-gray-100 text-gray-900 border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-500"
                placeholder="https://"
              />
            </div>
          </div>
