...
export default function AIAssistantPanel({ isOpen, onClose }: AIAssistantPanelProps) {
  ...
  return (
    <div
      ref={panelRef}
      className="fixed top-[60px] inset-x-2 sm:inset-x-auto sm:left-1/2 sm:-translate-x-1/2 w-auto sm:w-96 max-w-[calc(100vw-1rem)] rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 shadow-2xl overflow-hidden z-50"
    >
      {/* Chat Header */}
